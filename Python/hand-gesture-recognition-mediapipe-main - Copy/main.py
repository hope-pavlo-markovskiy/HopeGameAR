    ...
    while True:
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                handInfo.append((Tag.HAND_LANDMARKS.value, landmark_list))
        ...
        ## Send Data  [humanSegmentationImg[trackData]
        _, buffer = cv.imencode(".jpg", debug_image)
        frameSize = len(buffer)  # Get the size of the compressed frame
        ...
        sock.sendall(struct.pack("!L", frameSize))
        sock.sendall(buffer.tobytes())  # Send the compressed frame data

        print(trackData)
        sock.sendall(str(trackData).encode())
