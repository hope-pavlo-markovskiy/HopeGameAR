...
public class BezierPath : MonoBehaviour
{
    ...
    /// <summary>
    /// Gets or sets a value indicating whether this <see cref="BezierPath"/> is dirty.
    /// </summary>
    /// <value>
    ...
    /// 	- the index
    /// </param>
    public BezierWaypoint this[int index]
    {
    ...
    /// </summary>
    [SerializeField] private BezierWaypoint[] points = new BezierWaypoint[0];
    public List<GameObject> gameObjectPoints = new List<GameObject>();
    ...
    public BezierWaypoint[] GetPoints()
    {
        return points;
    }
    ...
    /// 	- The point to add.
    /// </param>
    public void AddPoint(BezierWaypoint point)
    {
        List<BezierWaypoint> tempArray = new List<BezierWaypoint>(points);
        tempArray.Add(point);
    ...
    /// </param>
    public BezierWaypoint AddPointAt(Vector3 position)
    {
        UnityEngine.GameObject pointObject = new UnityEngine.GameObject("Point " + pointCount);
    ...
    /// 	- The point to remove
    /// </param>
    public void RemovePoint(BezierWaypoint point)
    {
        List<BezierWaypoint> tempArray = new List<BezierWaypoint>(points);
    ...
    /// </returns>
    public BezierWaypoint[] GetAnchorPoints()
    {
        return (BezierWaypoint[])points.Clone();
    }
    ...
    public Vector3 GetPointAt(float t)
    {
        ...
        BezierWaypoint p1 = null;
        BezierWaypoint p2 = null;
    ...
    public BezierWaypoint GetCurrentWaypoint(float t)
    {
        if (t <= 0) return points[0];
        else if (t >= 1) return points[points.Length - 1];
    ...
    public BezierWaypoint GetNextWaypoint(float t)
    {
    ...
    /// 	- Point to search for
    /// </param>
    public int GetPointIndex(BezierWaypoint point)
    {
        int result = -1;
    ...
    public void SetFirstWaypointPos(Vector3 pos)
    {
    ...
    /// </param>
    public static void DrawCurve(BezierWaypoint p1, BezierWaypoint p2, int resolution)
    {
    ...
    /// 	- Value between 0 and 1 representing the percent along the curve (0 = 0%, 1 = 100%)
    /// </param>
    public static Vector3 GetPoint(BezierWaypoint p1, BezierWaypoint p2, float t)
    {
    ...
    /// </param>
    public static float ApproximateLength(BezierWaypoint p1, BezierWaypoint p2, int resolution = 10)
    {
        float _res = resolution;
        float total = 0;
